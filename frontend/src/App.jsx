  ...
  {users.map((user, index) => (
    <li key={index} className="user-item">
      ...
      <span className="user-name">{user}</span>
       ...
       <p className={`typing-indicator ${typing ? "typing-dots" : ""}`}>
  {typing}
        </p>
        <select
      ...
      <div className="editor-wrapper">
        ...
        <textarea className="input-console" value={userInput} onChange={e=>setUserInput(
         e.target.value
        )} placeholder="Enter Input Here.."/>



        <button className="run-btn" onClick={runCode}>Compile</button>
